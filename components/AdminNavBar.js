  ...
  return (
    <nav className={navbarClass}>
      <div className="container mx-auto flex justify-between items-center">
        <div className="text-white font-bold text-2xl">THIS IS FOR ADMIN ONLY!</div>
        <ul className="flex space-x-4 items-center">
          <li>
            <Link href="/admin">
              <p className="text-white hover:text-gray-300 transition duration-300">Admin Home Page</p>
            </Link>
          </li>
